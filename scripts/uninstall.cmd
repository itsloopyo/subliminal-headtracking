...
:: ============================================
:: Subliminal Head Tracking - Uninstall
:: ============================================
...
:: Empty: this mod has shipped one payload name and no release yet.
set "LEGACY_DLLS="
...
:: own directory.
:: Empty: the mod reads and writes both beside the shipping exe, which is where
:: the payload goes, so MOD_LEFTOVERS covers them.
set "ROOT_EXTRAS="
